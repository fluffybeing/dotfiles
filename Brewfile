...
brew "starship"                 # Zsh powerline

# CLI Tools
brew "bat"                      # Enhanced file viewer (better `cat`)
brew "fastfetch"                # System information tool
brew "fnm"                      # Fast Node.js version manager
brew "gh"                       # GitHub CLI for managing PRs/issues
brew "git-delta"                # Better `git diff` and `grep` output
brew "pnpm"                     # Fast, efficient Node.js package manager
brew "prettyping"               # Prettified `ping` output
brew "python@3"                 # Required for `awscli`
brew "starship"                 # Prompt customization
brew "tlrc"                     # Community-driven command-line docs
brew "trash-cli"                # Record/remove/restore files (better `rm`)
